...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upiIdEt = (EditText)findViewById(R.id.upi_id);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String remarks = noteEt.getText().toString();


                if (amount.isEmpty())
                {
                 amountEt.setError("Enter valid amount");
                 amountEt.requestFocus();
                 return;
                }
                if (upiId.isEmpty())
                {
                    upiIdEt.setError("Enter an UPI ID");
                    upiIdEt.requestFocus();
                    return;
                }
                ...
                if (remarks.isEmpty())
                {
                    noteEt.setError("Enter a message");
                    noteEt.requestFocus();
                    return;
                }


                payUsingUpi(amount, upiId, name, remarks);
            }
        });
    }
